...
## The AI productivity paradox — the stakes made visible (2026)
[[2026-07-23-cagan-the-ai-productivity-paradox|The AI Productivity Paradox]] gives this principle a live, industry-scale demonstration. Generative AI makes it cheap to generate *more output* — McKinsey: adoption and investment are both accelerating; Atlassian's State of Teams 2026: 89% of executives say AI increased the speed of work, but only 6% can point to organization-wide ROI. Cagan's read: not actually a paradox. Teams still running the [[product-management-theater|project model]] use AI to accelerate output (business cases, roadmaps, PRDs, code) without ever addressing whether they're solving the right problem — this principle's violation, just faster. Teams in the product model use the same tools to accelerate *discovery and validation*, converting speed into outcomes. Cagan had hoped GenAI would be "the great equalizer" between companies with and without top engineering talent; instead the gap between product-model companies and everyone else is widening, because the advantage was never really delivery speed — it was culture, strategy, and discovery skill, all of which this principle depends on.
