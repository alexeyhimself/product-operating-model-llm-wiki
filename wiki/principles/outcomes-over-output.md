...
## Tensions & trade-offs
- **Nuance (Torres vs Cagan):** Teresa Torres defines product outcomes as *changes in human behavior*; Cagan generalizes to any **desired outcome the team can directly influence** (Huryn's example: Customer Effort Score). Coach watch-out: don't let easy-to-read proxy metrics substitute for the behavior change you actually need.
