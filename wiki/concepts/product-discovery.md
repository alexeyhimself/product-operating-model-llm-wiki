...
related: ["[[the-four-big-risks]]", "[[minimize-waste]]", "[[embrace-rapid-experimentation]]", "[[product-delivery]]", "[[time-to-money]]", "[[empowered-engineers]]", "[[the-product-team-trio]]", "[[overview]]", "[[discovery-health]]", "[[prototypes]]", "[[build-to-learn-vs-build-to-earn]]", "[[spotify-discover-weekly]]", "[[amazon-prime]]", "[[google-product-model]]", "[[opportunity-solution-tree]]", "[[continuous-interviewing]]", "[[assumption-testing]]", "[[teresa-torres]]", "[[continuous-discovery-habits]]"]
created: 2026-06-14
updated: 2026-07-12
---
...
### Torres's operational definition of *continuous* discovery
[[teresa-torres|Torres]]'s [[continuous-discovery-habits|CDH]] Ch 1 sharpens *continuous* into a four-clause operational definition, all four of which must hold:
- **weekly touchpoints with customers** (cadence, not campaigns)
- **by the team building the product** (not outsourced to research or agencies — the trio needs the empathy transfer)
- **where they conduct small research activities** (sustainable at a weekly cadence)
- **in pursuit of a desired outcome** (not research for research's sake)

Break any clause and continuous discovery becomes something else — occasional research, contracted research, a research phase before a project, or research disconnected from a decision. The **keystone habit** ([[continuous-interviewing|Torres's term]], Duhigg) is the weekly customer interview: teams that adopt it also start rapid prototyping and testing assumptions, per Torres's coaching-cohort observations.

Torres's frameworks operationalize discovery beneath this definition: [[opportunity-solution-tree|opportunity solution tree]] structures the space; [[continuous-interviewing|story-based interviewing]] feeds it; [[assumption-testing|assumption testing]] validates it. Cagan endorsed the whole system in the CDH Foreword.
