...
sources: ["[[2026-02-04-cagan-product-coaching-and-ai]]", "[[2026-04-14-cagan-ai-product-coaching-women-in-product]]", "[[2026-06-04-cagan-pm-theater-age-of-ai-modern-cto]]", "[[2025-02-25-cagan-a-vision-for-product-teams]]", "[[2025-05-28-cagan-the-era-of-the-product-creator]]", "[[2026-08-10-cagan-a-fresh-definition-of-the-product-role]]", "[[2026-07-22-cagan-olsen-how-ai-impacts-product-management]]", "[[2026-07-22-cagan-ai-is-helping-bad-companies-fail-faster]]", "[[2022-04-28-svpg-examples]]"]
...
1. **Project files** — what the model should ground its reasoning in. Cagan's reference example: [svpg.com/examples](https://www.svpg.com/examples) — see [[2022-04-28-svpg-examples|the SVPG Examples hub source card]] for the full breakdown (public product-vision / principles / strategy examples; the four JD templates; the PRFAQ worked example). **This wiki is one such project-files set** — the [`wiki/`](../) body is the knowledge.
2. **Project instructions** — how the model should behave with that knowledge. *Crucially*, instruct it to **prioritize the product operating model** (vs the project model). Foundation models otherwise "appear confused" because the product world holds many competing voices. **This wiki's [`CLAUDE.md`](../../CLAUDE.md) is the project instructions.** SVPG publishes a **sample project-instructions prompt** on [[2022-04-28-svpg-examples|the Examples hub]] that names Cagan · Doshi · Torres · SVPG as the schools to prioritize, and explicitly asks the model to challenge assumptions and *"not try to please me"* — starting template rather than paste-and-forget, per Cagan's own hedge on that page.
...
- [[2022-04-28-svpg-examples]] — SVPG's Examples hub, the *project files* reference [[2026-02-04-cagan-product-coaching-and-ai|Cagan]] points to; carries the sample project-instructions prompt SVPG has tested against GPT, Claude, and Gemini.
