...
## Why it matters
[[product-discovery|Discovery]] exists to address these risks cheaply *before* you build. Naming them keeps a team from defaulting to the only risk most engineers instinctively ask about (feasibility) while ignoring whether anyone wants it (value) or whether the business can support it (viability). Prototyping — testing a proposed solution against these four risks before committing engineers — is, per Cagan, "far and away, the most important discovery technique" for doing this cheaply ([[2025-09-12-cagan-the-purpose-of-prototypes|canon]]; see [[prototypes]]).
...
Cagan reframes the four risks for founders as **primary vs secondary**: the **primary** risk is almost always **value** — a product people will actually switch to — yet founders gravitate to the risk they're most comfortable with (often the business model). "Unless the product is right, you've got nothing." Value is usually the hardest of the four; demand is rarely the issue — a solution that is *significantly better* (Ben Horowitz's "~10× better") is. In the AI era, ML **raises the stakes on value and viability**, making the PM's ownership of those two risks more important, not less ([[2022-12-07-cagan-product-lessons-jobs-musk-20vc|20VC]], [[2023-05-17-cagan-10-misconceptions-startups-productx|10 Misconceptions]]) — see the fuller per-risk breakdown below.

## AI and the four risks
[[2024-04-16-cagan-ai-product-management|Cagan's dedicated AI treatment]] (Apr 2024) is the **root source** for how each risk intensifies for AI-powered products — it predates and grounds the wiki's earlier one-line AI mentions above (20VC, 10 Misconceptions, both 2022–2023) and the May 2025 Ep 20 podcast, all of which remain valid supporting/reinforcing citations. An even earlier precursor: [[2023-06-09-cagan-preparing-for-the-future|Preparing For The Future]] (Jun 2023) already touches the feasibility point (deterministic-vs-probabilistic quality, §6) and the viability/ethics point (§10) without structuring them into the formal four-risk breakdown — kept as supporting, not root.

- **Feasibility.** Generative AI is *probabilistic, not deterministic* — the same inputs can yield different outputs as the model's weightings shift with learning. Some capabilities suit probabilistic solutions well (a personalized feed tolerates an occasional miss); others don't (an insulin dose outside medical guidelines is unacceptable). Matching the technology to the product is, per Cagan, "perhaps the most fundamental consideration." The AI PM also owns quality assurance (acceptable error rates, mistake types, UX mitigations) and training-data quality/bias — often *the* real stumbling block, more than the model itself. See [[intelligent-products]] for the deeper philosophical version of this point.
- **Usability.** AI raises the bar on setting expectations for what the technology can and can't do — transparency is what builds trust and avoids frustration when limitations surface. Constraints now come from the PM as much as the designer; explaining the "why" behind an AI decision (explainability) can be essential to trust. Accuracy, speed, cost, and UX trade off against each other more visibly than in deterministic products.
- **Value.** AI's promise is real, but "AI in name only" products are common. The AI PM's first job is ensuring genuine, incremental value — solving real problems demonstrably better than existing solutions, not chasing AI for marketing parity.
- **Viability.** These are the risks that, per Cagan, "dominate today's news headlines": unit economics still immature and often expensive to *run*, not just build; data provenance and copyright questions; bias in training data; and legal/ethical exposure from probabilistic mistakes ("it is very possible for an AI-powered system to both save lives... yet also put lives in danger by making a mistake"). These questions "fall squarely on the shoulders of the AI product manager," in partnership with legal.

See [[ai-and-product-teams]] for the broader reshaping of team roles and skills under GenAI.
...
- **⚠️ "Five risks" / ethics as a separate risk.** Some popular framings (including [[pawel-huryn|Huryn]]'s posts) add **Ethics** as a fifth risk. Canonically Cagan keeps it to **four**, with **ethics part of business viability** ("ethical risk is part of business viability risk"). His reasoning: "once you get to more than 4, the real worry is that it just becomes a checklist and not a way of thinking." This wiki uses **four**, treating ethics — and go-to-market — as important lenses *within* viability. (Other frameworks vary: Strategyzer uses three — desirability, viability, feasibility; Torres recognizes the same five but visually emphasizes three.)
  - **The wiki carries this same tension internally.** [[product-ethics]] — grounded in Jon Moore and Christian Idiodi's *Product Therapy* Ep 5, a coaching-context podcast rather than book canon — calls ethics an "emerging fifth risk" in Moore's own words, without softening it to fit the four-risk frame. That's a deliberate choice, not an oversight: see that page's canon note for why the wiki keeps both framings side by side instead of picking a winner.
...
- [[product-ethics]] — the wiki's other page on ethics-as-risk; uses Moore's "fifth risk" podcast framing rather than this page's four-with-ethics-inside-viability canon. See the anti-pattern note above.
...
- [[2017-12-05-cagan-the-four-big-risks]] — **supporting explainer** (accompanies the *INSPIRED* 2nd-ed 2017 four-risk crystallization); the linkable article-form statement of the four risks + the trio risk-ownership table; useful for the *why-viability-was-promoted* framing ("obscuring some pretty serious risks … making it too easy for product managers to focus on customer value and overlook business value"). Does **not** carry ethics-inside-viability — that framing crystallizes from 2018 onward.
...
- [[2024-04-16-cagan-ai-product-management]] — **primary root** for the "AI and the four risks" section: the per-risk breakdown of how feasibility (probabilistic-vs-deterministic, training-data quality), usability (trust/transparency/explainability), value (genuine value vs. AI-for-marketing), and viability (unit economics, data provenance, ethics, legal exposure) intensify for AI-powered products.
- [[2023-06-09-cagan-preparing-for-the-future]] — supporting; an earlier (2023) precursor touching the feasibility (quality) and viability (ethics) points, without the formal four-risk structure.
...
- [[2025-09-12-cagan-the-purpose-of-prototypes]] — supporting; "the highest order use of a prototype is to help you discover a successful product," addressed against value/usability/feasibility/viability; the fidelity-is-risk-dependent framework (see [[prototypes]]).
