...
- **PM as build-to-earn engineer.** Being great at Claude Code is nice-to-have, not the PM's job; the job is to *discover something worth building*.

## In your context
_Field note: do your PMs prototype and test (build to learn), or wait for design/eng? Are you using discovery tools for discovery and delivery tools for delivery — or speeding up delivery and calling it product?_
...
- [[prototypes]] — the build-to-learn artifact; the four prototype types.
