---
title: Feedback (Coaching Framework)
type: framework
...
Lauchengco's two career-long tools for inserting a challenge without triggering defense:

- ***"I'm curious if…"***
- ***"Have we considered…"***

Both preserve status ("maybe we did, maybe I wasn't there") while introducing the counter-position; both work up-the-hierarchy and across peers. Lauchengco explicitly contrasts them with *"this is probably a stupid idea, but"* and *"I'm sure you've already considered this, but…"* — both of which prime the room to dismiss the idea before it lands.

## Where to hold the conversation
- **In person, or Zoom, or phone. Never email.**
   Ep 7's cautionary anecdote: Lauchengco's own boss delivered well-intended feedback via Friday email; she stewed on it all weekend before Monday's conversation clarified his (benign) intent. Text loses tone and expression — the human channel is what carries intent.
- **1:1, not in a group.** Positive feedback in public is fine; corrective feedback belongs private.

## Positive feedback — specificity, not kudos
The same framing rule applies to positive feedback: *"Great job on the presentation"* teaches nothing. *"I saw how much extra time you spent on the strategy section, and when you pointed out how competitor A was making a difference in competitor B's market and why we needed to respond, that was the real evidence of how much you've advanced your thinking"* — teaches the person which specific behavior to repeat. The discipline is the same: name **which action**, **which effect**, **why it matters** — not just the outcome.

## Feedback up the ladder — including the CEO
When giving feedback up (to a boss, an executive, a CEO), the frame is the same but the *"establish context"* step matters more. Lauchengco's board-level example: *"I think the world of you… let me tell you why I'm concerned, and I'm curious how you are feeling."* — power asymmetry compresses into a productive conversation once the intent is explicit. A CEO who wants to be challenged is a leader who has already earned the right conversation; a CEO who *cannot* be challenged has an org that will fail silently.
...
- **"Praise in public, criticize in private" as the whole answer.** True, but insufficient — the *specificity* of praise matters as much as its venue.
- **Framing challenge as challenge.** *"I disagree"* triggers defense; *"I'm curious if…"* opens the question. Same content, entirely different landing.
- **Withholding feedback because you *care*.** Lauchengco: *"if you're new in a role, or you find yourself in one where you've never gotten specific feedback, you may not realize the gift it is."* Silence is not kindness; it is the withholding of the input the person needs to iterate.
- **Softening the substance by softening the words.** These tools soften the *delivery* to preserve the *substance* — they are not permission to say less.

## In your context
_Agent prompt: when did the leader you're coaching last give one report a piece of specific corrective feedback in a 1:1? When did they last invite feedback about themselves from a report? Where in this team is a *stack of unspoken small comments* silently reshaping a working relationship?_

## Related
- [[coaching-mindset]] — the frame that makes feedback possible in the first place.
- [[coaching-the-pm]] — the systemic version; feedback is what the coaching plan produces at the moment level.
- [[trust-over-control]] — feedback requires trust; delivering feedback well grows trust.
- [[pm-competency]] — the assessment that feeds the systemic feedback loop.
- [[product-leadership]] — a leader whose reports never get specific feedback is not leading.
