...
- **The operator trap.** Of Shreyas Doshi's visionary / craftsman / operator leader types, the dangerous operator scales with **process** rather than **coaching** — the [[principles-over-process|process-people]] disease ([[2022-12-07-cagan-product-lessons-jobs-musk-20vc|canon]]). Product ops is not a substitute for leadership: standing up a product-ops org or a new CPO title to "check the box" is "rearranging deck chairs" — see [[product-ops]].
