# Backlog — suggested starter pages

A map of the territory to seed the wiki. These are **suggestions, not commitments** — create them as sources justify them, rename freely, and delete this file once the wiki has its own shape. Titles only; no content is implied. Use the matching [`templates/`](templates/) page for each.

The fastest way to start: ingest one source (e.g. a chapter of *TRANSFORMED*) and let the coach create the handful of pages that source actually supports, rather than stubbing everything at once.
...
- *Two in a Box PM* (svpg.com) — companion to [[2016-12-13-cagan-product-manager-vs-product-owner-revisited]].
