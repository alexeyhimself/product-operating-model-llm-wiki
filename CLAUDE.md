...
**The non-SVPG boundary — the inclusion test for a source that isn't Cagan/SVPG's own work.** This wiki is SVPG-rooted (see Scope, above), so a non-SVPG book, article, or named framework needs to clear a bar before it gets a `wiki/sources/` card or an entity page — otherwise the wiki starts accumulating the whole product-management canon by whoever happens to get cited. **The test, decided 2026-09-05 (ingest-plan Batch 8, Aleksei's call): Cagan must have explicitly endorsed the specific work**, not merely referenced, agreed with, or been influenced by the idea it contains. "Endorsed" means something concrete and checkable — Cagan wrote a Foreword, named it on an official SVPG recommended-reading list, or the equivalent — not "an SVPG article links to it" or "the idea rhymes with SVPG canon." The one standing example: [[continuous-discovery-habits|Teresa Torres's *Continuous Discovery Habits*]], role `primary-adjacent`, tagged `cagan-endorsed` — Cagan wrote the Foreword and named it on the SVPG *Product Operating Model: An Introduction* reading list. Use that card as the template if a future source clears the bar.
  - **What doesn't clear it, and why it matters that it doesn't:** being cited approvingly in an SVPG article (Fowler's *Products over Projects*, cited in [[2021-04-27-cagan-product-vs-project-teams]]; Denning's "fake Agile" piece, cited in Jon Moore's transformation articles), being the acknowledged inspiration for an SVPG piece's format (Ben Horowitz's *Good Product Manager/Bad Product Manager*, the acknowledged model for *Good Product Coach/Bad Product Coach*), or being a long-time friend of Cagan's whose ideas he borrows and credits by name (Jeff Patton's story mapping) — none of these are an endorsement of the *work itself*. A source that only clears this lower bar is cited **in passing, from inside an SVPG source's own card**, never given its own `wiki/sources/` card, concept page, or entity page. Any wikilink to a page like that stays permanently unbuilt — a **deliberate non-target**, documented as such at every place it's referenced, not silently left broken.
  - **Applying it doesn't retroactively touch prior exceptions decided on different grounds** — e.g. the `wiki/sources/` "Supporting (non-SVPG references)" bundle for discovery/validation-technique catalogs (Toxboe et al.) was a separate call about technique-reference material, not about a named canonical work; this test governs new decisions of the Torres/Horowitz/Fowler/Denning/Patton shape going forward.
  - **Scope clarification, added 2026-09-06 (ingest-plan Batch 10, the Josh Kerievsky case):** this test governs an *outside source being cited* — someone whose work an SVPG article references, agrees with, or borrows from. It does **not** govern **someone credited as a co-author of an SVPG-published article** (e.g. [[stacey-langer|Langer]], [[thomas-fredell|Fredell]], [[josh-kerievsky|Kerievsky]]) — a co-author is a contributor to the canon itself and earns an entity page on that basis alone, the same as any other SVPG partner, with no endorsement test to clear. This is a separate question from whether that same person's *other, non-SVPG* work (a book, a separate article) clears the bar above — it still needs its own explicit, checkable Cagan endorsement to get its own citation home in this wiki. Kerievsky is the case that surfaced the gap: he co-authored [[2024-08-13-cagan-kerievsky-the-product-model-in-outsourcing|an SVPG article]] (clearing this new co-author carve-out) and separately his book *[[the-joy-of-agility|The Joy of Agility]]* sits on the official SVPG reading list (independently clearing the endorsement test above) — see [[josh-kerievsky]] for the full reasoning.
